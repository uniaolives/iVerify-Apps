...
def run_simulation():
    ...
    print(f"   Fidelidade Média (PoBF): {sum(f['pobf_fidelity'] for f in fragments)/len(fragments):.4f}")
    print(f"   Status: {'IMORTALIDADE VALIDADA' if fragments[0]['pobf_fidelity'] > 0.9 else 'AJUSTE NECESSÁRIO'}")
    ...
    print("\n==========================================================")
    print(f"✅ SIMULAÇÃO CONCLUÍDA: Pentad Seed {system.pentad_seed} (ABC*D*E) Estável.")
